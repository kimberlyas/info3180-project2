...
def share_wishlist(userid): 
    ...
    if request.method == "POST":
        ...
        if user:
            ...
            link = "https://info3180-project2-kimberlyas.c9users.io/app#/wishList/" + str(user.id)
            msg = "Hello Family and friends, I'd like to get these items... Any item you can purchase will be greatly appreciated :) " + "" + link
